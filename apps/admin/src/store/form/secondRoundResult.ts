...
export const useSecondRoundResultValueStore = () => useRecoilValue(secondRoundResultAtomState);
export const useSetSecondRoundResultStore = () => useSetRecoilState(secondRoundResultAtomState);
