    ...
    <StyledCameraResponsibilityTeacher>
      <Table>
        <Row alignItems="center">
          <Th borderTopLeftRadius={12} width="calc(100% / 10)" height={56}>
            구분
          </Th>
        ...
        <Row alignItems="center">
          <Td width="calc(100% / 10)" height={56}>
            관리책임자
          </Td>
        ...
        <Row alignItems="center">
          <Td borderBottomLeftRadius={12} width="calc(100% / 10)" height={56}>
            접근권한자
          </Td>
          <Td width="calc(100% / 6)" height={56}>
            개인영상정보보호담당자
