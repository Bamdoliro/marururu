...
export const use검정고시SubjectListStore = () =>
  useRecoilState(검정고시SubjectListAtomState);
export const use검정고시SubjectListValueStore = () =>
  useRecoilValue(검정고시SubjectListAtomState);
export const useSet검정고시SubjectListStore = () =>
  useSetRecoilState(검정고시SubjectListAtomState);

export const useNew검정고시SubjectListStore = () =>
  useRecoilState(new검정고시SubjectListAtomState);
